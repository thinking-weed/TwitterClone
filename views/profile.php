        ...
        <div class="main">
            ...
            <div class="profile-area">
                ...
                <?php if($view_user['id'] !== $view_requested_user['id']): ?>
                        <!--相手のページ-->
                        <?php if(isset($view_requested_user['follow_id'])): ?><!--表示中のユーザーをフォローしていれば、true-->
                        ...
                        <?php else: ?>
                            <button class="btn btn-reverse btn-sm js-follow" data-followed-user-id="<?php echo $view_requested_user['id']; ?>" >フォローする</button>
