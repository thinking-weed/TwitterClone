...
if(isset($_POST['nickname']) && isset($_POST['name']) && isset($_POST['email'])){
    $data = [
        'id' => $user['id'], // 上のgetUserSessionで取得したもの
        'name' => $_POST['name'],
...
$requested_user_id = $user['id'];   //requested_user_idが表示するユーザーID
...
//プロフィール情報を取得
$view_requested_user = findUser($requested_user_id, $user['id']);//表示対象のユーザーを自分がフォローしているか？
